...
_q2_module = _load_module_from_same_folder("Butler Andrew X2Q2_SP24.py", "butler_andrew_x2q2")
...
class circuitView():
    ...
    def setupImageLabel(self):
        ...
        image_path = os.path.join(os.path.dirname(os.path.abspath(__file__)), "Circuit1.png")
        self.pixMap = qtg.QPixmap(image_path)
        self.image_label = qtw.QLabel(self.form)
        self.image_label.setPixmap(self.pixMap)
        self.image_label.setScaledContents(False)
        self.image_label.setAlignment(qtc.Qt.AlignmentFlag.AlignCenter)
